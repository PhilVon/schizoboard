...
| Cut | `Ctrl`+`Alt`+click a string — the scissors — or context menu → *Delete* | String removed; its pins stay where they are |
...
Strings         1–9 slack presets · Alt+wheel whole-string slack · Enter/Esc end run
                Ctrl+Alt+click a string cuts it — the scissors; the pointer says so
