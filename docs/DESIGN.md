...
- **Below 15% zoom** — string draws as straight one-pixel chords with no sag, pins hide, board ink comes from tile thumbnails. Items are unchanged from the tier above.
